...
export class DefaultVersionClassifier implements VersionClassifier {
  ...
  protected databasePattern: (commit: CommitInfo) => boolean
  ...
  constructor(config: ActionConfig) {
    ...
    this.databasePattern = this.parsePattern(
      config.databasePattern,
  ...
  public async ClassifyAsync(
    ...
    const { major, database, minor, patch } = this.getNextVersion(
      lastRelease,
      type
    )
